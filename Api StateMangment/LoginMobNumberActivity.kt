package com.festum.nearbybusiness.user.ui.main.view.Login
...
import com.festum.nearbybusiness.user.R
import com.festum.nearbybusiness.user.databinding.ActivityLoginMobNumberBinding
import com.festum.nearbybusiness.user.ui.DependencyInjecation.Repo.UserLoginViewModel
import com.festum.nearbybusiness.user.ui.DependencyInjecation.ResponseUtils.ApiResponse
import com.festum.nearbybusiness.user.ui.Model.Country
import com.festum.nearbybusiness.user.ui.Model.PostData
import com.festum.nearbybusiness.user.ui.adapter.CountryAdapter
...
class LoginMobNumberActivity : AppCompatActivity() {
    ...
    val loginModel: UserLoginViewModel by viewModels()
    ...
    private fun init() {
        lifecycleScope.launch {
            loginModel.data.collect {
                when (it) {
                    is ApiResponse.Success -> {
                        Log.e("TAG", "init: ------> Success")
                        Toast.makeText(this@LoginMobNumberActivity, "Success", Toast.LENGTH_SHORT)
                    }

                    is ApiResponse.Failure -> {
                        Log.e("TAG", "init: ------> Failure ${it.msg}")
                        Toast.makeText(this@LoginMobNumberActivity, "Failed", Toast.LENGTH_SHORT)
                    }

                    is ApiResponse.Loading -> {
                        Log.e("TAG", "init: ------> Loading")
                        Toast.makeText(this@LoginMobNumberActivity, "Loading", Toast.LENGTH_SHORT)
                    }
                }
            }
        }
