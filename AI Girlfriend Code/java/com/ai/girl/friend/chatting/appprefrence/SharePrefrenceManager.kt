...
import com.ai.girl.friend.chatting.appconstants.AiApplication

val sharedPreferencesManager: SharedPreferencesManager
    get() {
        return SharedPreferencesManager(AiApplication.AppContext.context)
    }
class SharedPreferencesManager(context: Context) {
    ...
    companion object {
        ...
        private const val PREF_NAME = "AiPref"
