...
class SecoundOnBoardingActivity : BaseBindingActivity<ActivityFirstOnBoardingBinding>() {
    ...
    override fun getActivityContext(): AppCompatActivity {
        return this@SecoundOnBoardingActivity
    }
    ...
    override fun onClick(v: View?) {
        ...
        {
            binding.ivNext ->{
                launchActivity(getActivityIntent<ThirdOnBoardingActivity> {  })
            }
        }
    }
