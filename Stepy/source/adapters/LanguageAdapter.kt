package com.steps.tracker.machine.analyzer.adapters
...
import com.steps.tracker.machine.analyzer.databinding.ItemLanguageBinding
import com.steps.tracker.machine.analyzer.features.ui.language.Language


class LanguageAdapter(val context: Context, val listener: OnLanguageClickListener) :
