...
class BMIChart @JvmOverloads constructor(
    ...
    private var colorBox = ContextCompat.getColor(context, R.color.colorPrimary)
    ...
    init {
        ...
        colorBox = typedArray.getColor(R.styleable.BMIChart_boxColor, ContextCompat.getColor(context, R.color.colorPrimary))
